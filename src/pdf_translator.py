...
class PDFTranslator:
    def __init__(self, dictionary_path=None):
        ...
        self.technical_terms = {
            ...
            # Relay Setting Calculation Document Terms
            "RELAY SETTING CALCULATION FOR": "CALCUL DE RÉGLAGE DE RELAIS POUR",
            "63kV PAC-ANCIEN PONT LINE DIFFERENTIAL & DISTANCE PROTECTION": "PROTECTION DIFFÉRENTIELLE ET DISTANCE DE LIGNE PAC-ANCIEN PONT 63kV",
            "NAME OF THE PROJECT: ALIMENTATION EN ENERGIE ELECTRIQUE EN UN POINT UNIQUE DE 2x30MVA PAR LIGNES PERSONNALISEES ET SECURISEES": "NOM DU PROJET : ALIMENTATION EN ENERGIE ELECTRIQUE EN UN POINT UNIQUE DE 2x30MVA PAR LIGNES PERSONNALISEES ET SECURISEES",
            "LINE DIFF PROTECTION RELAY : 7SL82-87L": "RELAIS DE PROTECTION DIFFÉRENTIELLE DE LIGNE : 7SL82-87L",
            
            # System Parameters
            "1 SYSTEM PARAMETERS:": "1 PARAMÈTRES SYSTÈME :",
            "System Voltage": "Tension système",
            "VT Primary": "TP Primaire",
            "VT Secondary": "TP Secondaire",
            "CT Primary": "TC Primaire",
            "CT Secondary": "TC Secondaire",
            "System frequency": "Fréquence système",
            "Continuous operating current": "Courant de fonctionnement continu",
            "Max fault MVA": "MVA de défaut max",
            "Max fault current": "Courant de défaut max",
            
            # Line Parameters
            "2 LINE PARAMETERS:": "2 PARAMÈTRES DE LIGNE :",
            "Line Data's in Primary": "Données de ligne au primaire",
            "Details": "Détails",
            "Parameters": "Paramètres",
            "Prot Line": "Ligne prot",
            "Shortest line": "Ligne la plus courte",
            "Longest line": "Ligne la plus longue",
            "Length": "Longueur",
            "KM": "KM",
            "+ve sequence in Ω/kM": "Séquence +ve en Ω/kM",
            "zero sequence in Ω/kM": "Séquence zéro en Ω/kM",
            "Resistance R1": "Résistance R1",
            "Reactance X1": "Réactance X1",
            "Resistance R0": "Résistance R0",
            "Reactance X0": "Réactance X0",
            
            # Differential Function Calculations
            "3 CALCULATION FOR DIFFERENTIAL FUNCTION :": "3 CALCUL POUR FONCTION DIFFÉRENTIELLE :",
            "Basic Differential setting (I-DIFF)": "Réglage différentiel de base (I-DIFF)",
            "The Pickup Value is set as 20% of the rated current of the line.": "La valeur de pickup est fixée à 20% du courant nominal de la ligne.",
            "20% of the Rated Current": "20% du courant nominal",
            "I-DIFF> Pickup value": "Valeur de pickup I-DIFF>",
            "Setting for 87-1 Value Idiff switch on :": "Réglage pour valeur 87-1 commutation Idiff :",
            "I Diff> switch on Settings should be greater than I-DIFF> Pickup value": "Les réglages de commutation I Diff> doivent être supérieurs à la valeur de pickup I-DIFF>",
            "30% of the Rated Current": "30% du courant nominal",
            "I Diff switch on": "Commutation I Diff",
            "Setting for 87-2 protection: I-DIFF >>": "Réglage pour protection 87-2 : I-DIFF >>",
            "In most cases, it is adequate to set the values to approx. 100 % to 200 % of the operational nominal current.": "Dans la plupart des cas, il est adéquat de fixer les valeurs à environ 100 % à 200 % du courant nominal opérationnel.",
            "Nominal current of the line": "Courant nominal de la ligne",
            "Therefore, as seen by the CT secondary": "Par conséquent, tel que vu par le secondaire TC",
            "Value set for 87-2 Pickup (I-DIFF >>)": "Valeur fixée pour pickup 87-2 (I-DIFF >>)",
            "I-DIFF >> SWITCHON should be 2 to 3 times the setting value of I-DIFF >>": "I-DIFF >> SWITCHON doit être 2 à 3 fois la valeur de réglage de I-DIFF >>",
            "Value for 87-2 under Switch on condition": "Valeur pour 87-2 sous condition de commutation",
            "Value set for 87-2 under Switch on (I-DIFF >> Switch on)": "Valeur fixée pour 87-2 sous commutation (I-DIFF >> Commutation)",
            "The below mentioned setting recommended,": "Le réglage mentionné ci-dessous est recommandé,",
            "I-DIFF>": "I-DIFF>",
            "I-DIFF>SWITCH ON": "COMMUTATION I-DIFF>",
            "T-DELAY I-DIFF>": "T-TEMPORISATION I-DIFF>",
            "I-DIFF>>": "I-DIFF>>",
            "I-DIF>>SWITCHON": "COMMUTATION I-DIF>>",
            "INRUSH REST.": "REST. APPEL",
            "OFF": "ARRÊT",
            "Sec": "Sec",
            
            # Distance Calculation
            "4 Distance Calculation:": "4 Calcul de distance :",
            "Zone Reach Details": "Détails de portée de zone",
            "The relay shall work in Permissive Over Reach (POR) mode with the following settings:": "Le relais doit fonctionner en mode Permissive Over Reach (POR) avec les réglages suivants :",
            "of the protected Line": "de la ligne protégée",
            "of the shortest adjacent Line": "de la ligne adjacente la plus courte",
            "of the longest adjacent Line": "de la ligne adjacente la plus longue",
            "VT Ratio": "Rapport TP",
            "CT Ratio": "Rapport TC",
            "63x1000 / 110": "63x1000 / 110",
            "1000 / 1": "1000 / 1",
            "Transformation Ratio": "Rapport de transformation",
            "CT Ratio / VT Ratio": "Rapport TC / Rapport TP",
            "Calculated Sec Impedance Zsec": "Impédance sec calculée Zsec",
            "N x Z prim in ohm": "N x Z prim en ohm",
            "Zprim": "Zprim",
            "Primary Impedance in ohm": "Impédance primaire en ohm",
            
            # Protected Line Details
            "Protected Line:": "Ligne protégée :",
            "Line Length": "Longueur de ligne",
            "3.12 Km": "3,12 Km",
            "Line Total +VE Seq Impedance": "Impédance séq +VE totale de ligne",
            "(R1": "(R1",
            "+j": "+j",
            "X1)": "X1)",
            "Line Total Zero Seq Impedance": "Impédance séq zéro totale de ligne",
            "(R0": "(R0",
            "X0)": "X0)",
            
            # Adjacent Line Details
            "Adjacent Shortest Line:": "Ligne adjacente la plus courte :",
            "Adjacent Longest Line:": "Ligne adjacente la plus longue :",
            "7.53 km": "7,53 km",
            "7.5 km": "7,5 km",
            "Total +VE Sequence Impedance": "Impédance séquence +VE totale",
            "Total Zero Sequence Impedance": "Impédance séquence zéro totale",
            
            # Earth Impedance Ratio Settings
            "SETTING FOR EARTH IMPEDANCE RATIO": "RÉGLAGE POUR RAPPORT D'IMPÉDANCE DE TERRE",
            "Resistance Ratio": "Rapport de résistance",
            "RE/RL": "RE/RL",
            "1/3((R0/R1)-1)": "1/3((R0/R1)-1)",
            "Reactance Ratio": "Rapport de réactance",
            "XE/XL": "XE/XL",
            "X1-Z4": "X1-Z4",
            "20% x X1 x N": "20% x X1 x N",
            "0.365 x 1.745 x 0.2": "0,365 x 1,745 x 0,2",
            "0.128 ohm": "0,128 ohm",
            
            # Zone Timer Settings
            "ZONE TIMER SETTING": "RÉGLAGE DE TEMPORISATEUR DE ZONE",
            "ZONE 1- t1 PP": "ZONE 1- t1 PP",
            "ZONE 1- t1 PE": "ZONE 1- t1 PE",
            "ZONE 2- t1 PP": "ZONE 2- t1 PP",
            "ZONE 2- t1 PE": "ZONE 2- t1 PE",
            "ZONE 3- t1 PP": "ZONE 3- t1 PP",
            "ZONE 3- t1 PE": "ZONE 3- t1 PE",
            "ZONE 4- t1 PP": "ZONE 4- t1 PP",
            "ZONE 4- t1 PE": "ZONE 4- t1 PE",
            "0.00 sec": "0,00 sec",
            "0.35 sec": "0,35 sec",
            "0.80 sec": "0,80 sec",
            "0.50 sec": "0,50 sec",
            ...
            "5 Broken Wire": "5 Fil cassé",
            "Broken Wire": "Fil cassé",
            "Time delay": "Temporisation",
            "60": "60",
            "ON": "MARCHE",
            
            # Power Swing Protection
            "6 POWER SWING": "6 OSCILLATION DE PUISSANCE",
            "Power swing operating mode": "Mode de fonctionnement oscillation de puissance",
            "All zones blocked": "Toutes zones bloquées",
            "Max.Blocking Time": "Temps de blocage max.",
            "2": "2",
            
            # Load Impedance and Angle Calculation
            "Load Impedance and Load Angle Calculation": "Calcul d'impédance de charge et d'angle de charge",
            "CT Ratio considered as Maximum Load current of the Feeder": "Rapport TC considéré comme courant de charge maximum de l'alimentation",
            "Maximum Load Current": "Courant de charge maximum",
            "412.5": "412,5",
            "150% of operating current": "150% du courant de fonctionnement",
            "Minimum Operating Voltage": "Tension de fonctionnement minimum",
            "0.85 x Un": "0,85 x Un",
            "0.85 x 63 x 1000": "0,85 x 63 x 1000",
            "53550 V": "53550 V",
            "Load Impedance ZLoad": "Impédance de charge ZLoad",
            "Umin / sqrt(3) x Imax": "Umin / sqrt(3) x Imax",
            "53550 / sqrt(3) x 412.5": "53550 / sqrt(3) x 412,5",
            "ZLoad": "ZLoad",
            "Primary": "Primaire",
            "74.951 ohm": "74,951 ohm",
            "Secondary": "Secondaire",
            "74.951 x 1.745": "74,951 x 1,745",
            "130.79 ohm": "130,79 ohm",
            "131 ohm": "131 ohm",
            "RLoad": "RLoad",
            "ZLoad min Sec * Cosφmin": "ZLoad min Sec * Cosφmin",
            "131 * 0.8": "131 * 0,8",
            "Rloadmin": "Rloadmin",
            "104.8 ohm": "104,8 ohm",
            "Minimum Power Factor": "Facteur de puissance minimum",
            "Cosφmin": "Cosφmin",
            "0.80": "0,80",
            "φmin": "φmin",
            "36.86 deg": "36,86 deg",
            "Set Load Angle": "Réglage angle de charge",
            "φmin + 5": "φmin + 5",
            "36.86 + 5\"": "36,86 + 5\"",
            "42 deg": "42 deg",
            
            # High Speed SOTF
            "7 HIGHSPEED SOTF O/C": "7 SOTF HAUTE VITESSE S/I",
            "SOTF to be enabled for Zone-1 and Zone-2": "SOTF à activer pour Zone-1 et Zone-2",
            "Operate delay": "Temporisation de fonctionnement",
            "3": "3",
            
            # Fuse Fail Monitoring
            "8 FUSE FAIL MONITORING": "8 SURVEILLANCE DÉFAILLANCE FUSIBLE",
            "MINIMUM VOLTAGE THRESHOLD U>": "SEUIL TENSION MINIMUM U>",
            "30": "30",
            "MAXIMAM CURRENT THRESHOLD I<": "SEUIL COURANT MAXIMUM I<",
            "0.1": "0,1",
            "MAXIMUM VOLTAGE THRESHOLD U<(3P)": "SEUIL TENSION MAXIMUM U<(3P)",
            "10": "10",
            "DELTA CURRENT THRESHOLD(3PH)": "SEUIL COURANT DELTA(3PH)",
            "VOLTAGE FAILURE SUPERVISION": "SUPERVISION DÉFAILLANCE TENSION",
            "WITH CURRENT SUPERVISION": "AVEC SUPERVISION COURANT",
            "DELAY VOLTAGE FAILURE SUPERVISION": "TEMPORISATION SUPERVISION DÉFAILLANCE TENSION",
            "5": "5",
            "SEC": "SEC",
            
            # Directional Overcurrent Settings
            "9 Dir.Over current Settings : 67": "9 Réglages surintensité directionnelle : 67",
            "Directional Mode": "Mode directionnel",
            "Forward": "Avant",
            "RCA": "RCA",
            "45°": "45°",
            "Inverse-T 1:Threshold": "Seuil inverse-T 1",
            "150% of Load Current": "150% du courant de charge",
            "1.5*275=412.5A": "1,5*275=412,5A",
            "0.41 A": "0,41 A",
            "TMS": "TMS",
            "0.44": "0,44",
            "IEC curve": "Courbe IEC",
            "SI": "SI",
            
            # Directional Earth Fault Settings
            "10 Dir. Earth Fault Settings : 67N": "10 Réglages défaut terre directionnel : 67N",
            "-45°": "-45°",
            "3I0p Pickup current in A(Is)": "Courant de pickup 3I0p en A(Is)",
            "20% of load Current": "20% du courant de charge",
            "0.2*275=55A": "0,2*275=55A",
            "0.06 A": "0,06 A",
            
            # Non Directional DMT Overcurrent Settings
            "11 Non Directional DMT Overcurrent Settings : 50": "11 Réglages surintensité DMT non directionnelle : 50",
            "Pickup current in A (Is)": "Courant de pickup en A (Is)",
            "100% of Fault current considered": "100% du courant de défaut considéré",
            "1*8250": "1*8250",
            "8250": "8250",
            "Pickup current in Secondary A (Is)": "Courant de pickup au secondaire A (Is)",
            "8.25 A": "8,25 A",
            "0.15 sec": "0,15 sec",
            "DT": "TD",
            
            # Non Directional DMT Earth Fault Settings
            "12 Non Directional DMT Earth Fault Settings : 50N": "12 Réglages défaut terre DMT non directionnel : 50N",
            "Pickup current in A(Is)": "Courant de pickup en A(Is)",
            "1*1100": "1*1100",
            "1100": "1100",
            "1.10 A": "1,10 A",
